...
public class DaftarPengurusPresenter {
    ...
    public void kirimDataPengurus(final Context context, String id_user, String nama_anggota, String nim_anggota, String prodi_anggota, String email_anggota, String jabatan_anggota, String no_hp_anggota, String url_foto_ktm_anggota, String url_foto_anggota, String status_anggota) {
        apiServiceServer = ClientServer.getInstanceRetrofit();
        apiServiceServer.postDataPengurus(id_user, nama_anggota, nim_anggota, prodi_anggota, email_anggota, jabatan_anggota, no_hp_anggota, url_foto_ktm_anggota, url_foto_anggota, status_anggota)
